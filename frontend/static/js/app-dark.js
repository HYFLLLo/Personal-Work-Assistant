...
class App {
    ...
    renderHistoryList() {
            ...
            this.historyModalBody.innerHTML = `
                <div class="history-empty">
                    <div class="history-empty-icon">
                        <svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="#1E90FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="filter: drop-shadow(0 2px 4px rgba(0,0,0,0.3));">
        ...
        this.historyModalBody.innerHTML = history.map(item => {
            ...
            const statusIcon = item.status === 'completed' 
                ? `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#00d084" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>`
                : `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#ff4757" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>`;
                ...
                <div class="history-list-item" data-id="${item.id}" tabindex="0" role="button">
                    ...
                    <div class="history-item-meta">
                        ...
                        <div class="history-item-status ${item.status}">
                            ${statusIcon} ${item.status === 'completed' ? '已完成' : '失败'}
                        </div>
                    </div>
                </div>
            `;
    ...
    startProcessing(query) {
        ...
        this.submitBtnIcon.innerHTML = '<div class="btn-loader"></div>';
        ...
        const callbacks = {
            ...
            start: (data) => {
                ...
                this.addWorkflowStep('start', this.getRocketIcon(), '任务启动', '开始处理用户请求');
            },
            planner_update: (data) => {
            ...
            retry_trigger: (data) => {
                ...
                this.addWorkflowStep('retry', this.getRefreshIcon(), '重新规划', data.message || '验证失败，正在重新规划...');
            },
            final_report: (data) => {
    ...
    endProcessing() {
        ...
        this.submitBtnIcon.innerHTML = this.getRocketIcon();
    ...
    showNotification(message, type) {
        const icons = {
            success: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#00d084" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="filter: drop-shadow(0 2px 4px rgba(0,0,0,0.3));"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>`,
            error: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#ff4757" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="filter: drop-shadow(0 2px 4px rgba(0,0,0,0.3));"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>`,
            warning: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#ffa502" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="filter: drop-shadow(0 2px 4px rgba(0,0,0,0.3));"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>`
        };
        ...
        this.workflowNodes.innerHTML = `
            <div class="workflow-module" id="module-planner">
                <div class="workflow-module-header">
                    <div class="module-icon">${this.getBrainIcon()}</div>
            ...
            <div class="workflow-module" id="module-executor">
                <div class="workflow-module-header">
                    <div class="module-icon">${this.getSearchIcon()}</div>
            ...
            <div class="workflow-module" id="module-reporter">
                <div class="workflow-module-header">
                    <div class="module-icon">${this.getDocumentIcon()}</div>
    ...
    addVerificationStep(data) {
        ...
        const icon = isValid 
            ? `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#00d084" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>`
            : `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ffa502" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>`;
    ...
    addErrorStep(title, message) {
        const icon = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ff4757" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>`;
        const stepId = this.addWorkflowStep('error', icon, title, message, 'reporter');
        const stepEl = document.getElementById(stepId);
        const stepNumber = stepEl.querySelector('.step-number');
        if (stepNumber) {
